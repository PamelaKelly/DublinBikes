...
def make_db_tables():
    try:
        ...
        with conn.cursor() as cursor:
            ...
            sql = "CREATE TABLE IF NOT EXISTS bike_stations(station_number INT(11) NOT NULL,station_name VARCHAR(45) NOT NULL,station_address VARCHAR(45) NOT NULL,station_location FLOAT NOT NULL,banking_available TINYINT(1) NOTNULL, PRIMARY KEY (station_number),FOREIGN KEY (station_number) REFERENCES availability(station_number)"
            cursor.execute(sql)
